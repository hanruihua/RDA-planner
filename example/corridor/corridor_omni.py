...
env = EnvBase('corridor_omni.yaml', save_ani=False, full=False, display=True)
...
if __name__ == '__main__':
    ...
    car_tuple = car(robot_info.G, robot_info.h, robot_info.cone_type, robot_info.wheelbase, [10, 6.28], [10, 2], 'omni')
