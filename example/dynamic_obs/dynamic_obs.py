...
def main():
    ...
    mpc_opt = MPC(car_tuple, ref_path_list, receding=10, sample_time=env.step_time, process_num=5, max_edge_num=4, max_obs_num=6, min_sd=0.5, wu=0.2, obstacle_order=True, ro1=4, iter_num=3, original=True)
